...
const Features = () => {
    ...
    return (
    <section className='common-padding overflow-hidden h-full bg-zinc-800 relative'>
        <div className='screen-max-width'>
            <div className='mb-12 w-full'>
                <h1 id='features_title' className='section-heading'> Explore the full Story
                </h1>
            </div>
            <div className='flex flex-col justify-center items-center overflow-hidden'>
                ...
                <div className='flex flex-col sm:px-10'>
                    ...
                    <div className='flex-auto flex-col relative w-full'>
